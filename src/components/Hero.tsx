        ...
        <div className="flex flex-col-reverse md:flex-row items-center gap-8 md:gap-12">
          <div className="w-full md:w-1/2 text-center md:text-left">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-black mb-4 md:mb-6">
              Clean up your Google Photos in bulk.
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              ...
              >
                <a
                  href="https://www.youtube.com/watch?v=U24wJNhfNIY"
                  target="_blank"
                ...
                <div className="absolute top-0 left-0 w-56 h-56 bg-white border-4 border-black shadow-neo rotate-6">
                  <div className="grid grid-cols-3 gap-2 p-3 h-full">
                    {[...Array(9)].map((_, i) => (
                      <div
                        key={i}
                        className="w-full h-auto aspect-square bg-neo-gray border-2 border-black"
                      >
                        {i % 3 === 0 && (
                  ...
                  <div className="flex items-center justify-center h-full">
                    <div className="grid grid-cols-3 gap-2 p-4">
                      {[...Array(9)].map((_, i) => (
                        <div
                          key={i}
                          className="w-12 h-12 bg-neo-gray border-2 border-black"
                        >
                          {i % 3 === 0 && (
                            <div className="w-full h-full flex items-center justify-center">
                              <Images size={20} />
